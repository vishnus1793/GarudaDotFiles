...
const StaffDashboard = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            // Instead of sending to the backend, directly add the event to the state for review
            const newEventData = { ...newEvent, status: 'Pending Approval' }; // Set a default status
            setEvents((prevEvents) => [...prevEvents, newEventData]); // Update state to include the new event
