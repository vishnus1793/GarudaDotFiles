...
mongoose.connect('mongodb://localhost:27017/eventManagementDB', { useNewUrlParser: true, useUnifiedTopology: true });

// Define the schema and model (assuming `enrollments` collection)
const enrollmentSchema = new mongoose.Schema({
  name: String,
  email: String,
  phone: String,
...
// API route to fetch registrations by `eventId`
