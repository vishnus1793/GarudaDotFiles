...
import './chatgpt.css' // Import your CSS
...
const Page404 = () => {
  ...
  useEffect(() => {
    // JavaScript to toggle the menu and handle active link
        ...
        <CRow className="justify-content-center">
          <CCol md={6}>
            <div className="text-center">
              <h1 className="display-3">ChatGpt</h1>
            ...
            {/* Flexbox container to align navigation menu and form side-by-side */}
            <div className="d-flex align-items-start justify-content-between mt-4">
              ...
              {/* Search Input Group */}
              <CInputGroup className="input-prepend mt-3 w-75 ms-4">
                <CInputGroupText>
