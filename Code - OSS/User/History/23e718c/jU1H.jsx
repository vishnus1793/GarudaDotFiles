...
const AdminDashboard = () => {
    ...
    const handleApprove = async (eventId) => {
        try {
            ...
            console.log('Updating event with ID:', eventId, 'Status:', updatedEvent);
            ...
            console.error("Error approving event:", error.response ? error.response.data : error);
        }
    };
    ...
    const handleReject = async (eventId) => {
        try {
            ...
            console.error("Error rejecting event:", error.response ? error.response.data : error);
        }
    };
