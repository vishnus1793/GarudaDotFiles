...
const AdminDashboard = () => {
    ...
    const handleApprove = async (eventId) => {
      console.log(`Approving event with ID: ${eventId}`); // Debug log
      try {
  ...
  const handleReject = async (eventId) => {
      console.log(`Rejecting event with ID: ${eventId}`); // Debug log
      try {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-black via-gray-800 to-black">
            ...
            <div className="relative z-10 max-w-5xl mx-auto text-center py-8">
                ...
                <p className="text-lg text-gray-400 mb-10">Manage and approve college events efficiently.</p>
            </div>
